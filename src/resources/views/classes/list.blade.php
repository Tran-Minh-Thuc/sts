        ...
        <div class="frame-parent10">
            ...
            <div class="frame-parent15">
                ...
                <div class="ti-khon-parent">
                    ...
                    <div class="h-v-tn">Giảng viên phụ trách</div>
                    <div class="email">Tên lớp</div>
                    <div class="quyn">Tên bộ phận</div>
                    <div class="quyn">Tên khóa học</div>
                </div>
                ...
                <div class="frame-parent16">
                    <div class="trn-minh-thc">
                        <div class="chnh-sa-parent">
                            <a href="update-classes/{{$class['id']}}" class="chnh-sa">Chỉnh sửa</a>
                        </div>
                    </div>
                    <div class="trn-minh-thc">{{$class['teacher_name']}}</div>
                    <div class="tranminhthugmailcom">{{$class['name']}}</div>
                    <div class="tranminhthugmailcom">{{$class['department_name']}}</div>
                    <div class="tranminhthugmailcom">{{$class['course_name']}}</div>
                </div>
                @else
