        ...
        <div class="frame-parent10">
            ...
            <div class="frame-parent15">
                ...
                <div class="ti-khon-parent">
                    ...
                    <div class="h-v-tn">Tên học kì</div>
                    <div class="email">Ngày bắt đầu</div>
                    <div class="quyn">Ngày kết thúc</div>
                </div>
                ...
                <div class="frame-parent16">
                    <div class="trn-minh-thc">
                        <div class="chnh-sa-parent">
                            <a href="update-semesters/{{$semester['id']}}" class="chnh-sa">Chỉnh sửa</a>
                        </div>
                    </div>
                    <div class="trn-minh-thc">{{$semester['name']}}</div>
                    <div class="tranminhthugmailcom">{{$semester['start_time']}}</div>
                    <div class="tranminhthugmailcom">{{$semester['end_time']}}</div>
                </div>
                @else
