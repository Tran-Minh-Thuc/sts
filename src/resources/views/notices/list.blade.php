                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="form-group">
                                    <a type="button" href="create-notices" class="btn mb-1 btn-primary btn-lg btn-block">Thêm một thông báo mới</a>
                                </div>
