...
<body>
    <div class="trang-thm-mi-ngi-dng">
        ...
        <div class="frame-parent10">
            <form action="create-notices" method="post" enctype="multipart/form-data">
                @csrf
                <div class="instance-parent">
                    ...
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="text" name="name" id="name" class="frame-parent18" value="">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                    ...
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="date" name="start_time" class="frame-parent18" value="">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="date" name="end_time" class="frame-parent18" value="">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">hình ảnh</div>
                            </div>
                            <div class="frame-parent17">
                                <input type="file" name="image" class="frame-parent18" value="">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="text" name="location" class="frame-parent18" value="">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="text" name="note" class="frame-parent18" value="">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="text" name="type" class="frame-parent18" value="">
                            </div>
                        </div>
                    </div>
                </div>
