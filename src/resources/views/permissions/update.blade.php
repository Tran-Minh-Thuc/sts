    ...
    <div class="trang-thm-mi-ngi-dng">
                    ...
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">Tên quyền</div>
                            </div>
                            <div class="frame-parent17">
                                <input type="text" name="name" id="name" class="frame-parent18" value="{{$permission['name']}}">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="text" class="frame-parent18" value="{{$permission['created_at']}}" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="text" class="frame-parent18" value="{{$permission['updated_at']}}" disabled>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="form-del-cri" class="button-muangay-wrapper" style="height:50px; top: 790px;display:none;">
            <div class="button-muangay" style="background-color: brown;">
                <form action="/admin/delete-permissions/{{$permission['id']}}" method="post">
                    @csrf
                    @method('delete')
