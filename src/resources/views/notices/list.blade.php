...
<body>
    <div class="trang-danh-sch-ngi-dng">
        <div class="foodter">
        ...
        <div class="trang-danh-sch-ngi-dng-inner">
            <div class="frame-container">
                ...
                <div class="instance-frame">
                    <div class="frame-parent2">
                        <div class="danh-sch-ng-vin-wrapper">
                            <div class="danh-sch-ng1">Hồ sơ cá nhânnhân</div>
                        </div>
                ...
                <div class="instance-frame">
                    <div class="frame-parent2">
                        <div class="danh-sch-ng-vin-wrapper">
                            <div class="danh-sch-ng1">Thêm mới người dùngdùng</div>
                        </div>
        ...
        <div class="frame-parent10">
            ...
            <div class="frame-parent15">
                ...
                <div class="ti-khon-parent">
                    <div class="ti-khon">Hành động</div>
                    <div class="h-v-tn">Tên hoặt động</div>
                    <div class="email">Học kì</div>
                    <div class="quyn">Thời gian bắt đầu</div>
                    <div class="trng-thi">Thời gian kết thúc</div>
                </div>
                @foreach ($notices as $key => $notice)
                @if($key % 2 == 0)
                <div class="frame-parent16">
                    <div class="parent">
                        <img class="frame-inner" alt="" src="data:image/png;base64,{{$notice['image']}}" alt="Red dot" />

                        <div class="chnh-sa-parent">
                            <a href="update-notices/{{$notice['id']}}" class="chnh-sa">Chỉnh sửa</a>
                        </div>
                    </div>
                    <div class="trn-minh-thc">{{$notice['name']}}</div>
                    <div class="tranminhthugmailcom">{{$notice['semester_name']}}</div>
                    <div class="adminadmin">{{$notice['begin_time']}}</div>
                    <div class="hot-ng">{{$notice['end_time']}}</div>
                </div>
                @else
