    ...
    <div class="trang-thm-mi-ngi-dng">
        ...
        <div class="frame-parent10">
            <form action="update-notices/{{$notice['id']}}" method="post" enctype="multipart/form-data">
                ...
                <div class="instance-parent">
                    ...
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="text" name="name" id="name" class="frame-parent18" value="{{$notice['name']}}">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <select class="thng-tin-lin" name="semester_id" id="semester_id">
                                    <option value="{{$notice['semester_id']}}" selected>{{$notice['semester_name']}}</option>
                                    @foreach($semesters as $semester)
                                    @if($semester['id'] != $notice['semester_id'])
                    ...
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="date" name="start_time" class="frame-parent18" value="{{$notice['begin_time']}}">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="date" name="end_time" class="frame-parent18" value="{{$notice['end_time']}}">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">Nơi thực hiện</div>
                            </div>
                            <div class="frame-parent17">
                                <input type="text" name="location" class="frame-parent18" value="{{$notice['location']}}">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">Ghi chú</div>
                            </div>
                            <div class="frame-parent17">
                                <input type="text" name="note" class="frame-parent18" value="{{$notice['note']}}">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">Kiểu thông báo</div>
                            </div>
                            <div class="frame-parent17">
                                <input type="text" name="type" class="frame-parent18" value="{{$notice['type']}}">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="text" class="frame-parent18" value="{{$notice['created_at']}}" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="text" class="frame-parent18" value="{{$notice['updated_at']}}" disabled>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <img id="update-image-prv"  class="frame-icon" alt="" src="data:image/png;base64,{{$notice['image']}}" style="display: block;"/>
            ...
            <div id="form-del-cri" class="button-muangay-wrapper" style="height:50px; top: 790px;display:none;">
                <div class="button-muangay" style="background-color: brown;">
                    <form action="/admin/delete-notices/{{$notice['image']}}" method="post">
                        @csrf
                        @method('delete')
