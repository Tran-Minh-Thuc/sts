        ...
        <div class="frame-parent10">
            ...
            <div class="frame-parent15">
                ...
                <div class="frame-parent16">
                    <div class="parent">
                        <div class="div">{{$student['student_code']}}</div>
                        <img class="frame-inner" alt="" src="data:image/png;base64,{{$student['image']}}" alt="Red dot" />
                        <div class="chnh-sa-parent">
                            <a href="update-students/{{$student['id']}}" class="chnh-sa">Chỉnh sửa</a>
                        </div>
                    </div>
                    <div class="trn-minh-thc">{{$student['full_name']}}</div>
                    <div class="tranminhthugmailcom">{{$student['email']}}</div>
                    <div class="hot-ng">{{$student['date_of_birth']}}</div>
                    <div class="hot-ng">{{$student['phone_number']}}</div>
                </div>
                @else
