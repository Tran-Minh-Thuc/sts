        ...
        <div class="frame-parent10">
            ...
            <div class="frame-parent15">
                ...
                <div class="ti-khon-parent">
                    ...
                    <div class="h-v-tn">Tên đăng nhập</div>
                    <div class="email">Mật khẩu</div>
                    <div class="quyn">Quyền</div>
                    <div class="quyn">Trạng thái</div>
                </div>
                ...
                <div class="frame-parent16">
                    <div class="trn-minh-thc">
                        <div class="chnh-sa-parent">
                            <a href="update-accounts/{{$account['id']}}" class="chnh-sa">Chỉnh sửa</a>
                        </div>
                    </div>
                    <div class="trn-minh-thc">{{$account['user_name']}}</div>
                    <div class="tranminhthugmailcom">{{$account['password']}}</div>
                    <div class="tranminhthugmailcom">{{$account['permission_name']}}</div>
                    @if($account['status'] == "TRUE")
                    <div class="tranminhthugmailcom">Đang hoặt động</div>
                    @elseif($account['status'] == "FALSE")
                    <div style="color: red;" class="tranminhthugmailcom">Ngưng hoặt động</div>
                    @endif
                </div>
                @else
