          ...
          <div class="col-xl-6 col-md-12">
            <div class="card">
              <div class="card-content">
                <div class="card-body">
                    <form action="update-criterias/{{$criteria['parent_criteria_id']}}" method="post">
                        @csrf
                        @method('put')
                    <div class="form-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" id="donationinput3" class="form-control" value="{{$value['max_score']}}" placeholder="Điểm tối đa" name="max_score">
                      </div>

                      <div class="form-group">
                        <label for="donationinput4" class="sr-only">Điểm mặc định</label>
                        <input type="number" id="donationinput4" class="form-control" value="{{$value['default_score']}}" placeholder="Điểm mặc định" name="default_score">
                      </div>
                      <div class="form-group">
