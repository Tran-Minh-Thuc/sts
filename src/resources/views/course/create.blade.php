    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
                <h3 class="content-header-title">Thêm mới khóa học</h3>
            </div>
        </div>
                    ...
                    <div class="col-xl-6 col-md-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form" action="create-courses" method="post">
                                        @csrf
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label for="donationinput1" class="sr-only">Tên khóa</label>
                                                <input type="text" id="donationinput1" class="form-control" placeholder="Tên khóa" name="name">
                                            </div>
                                            <div class="form-group">
