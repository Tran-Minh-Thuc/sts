                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control border-0 py-3" value="{{ $child_parent->max_score }}" placeholder="0" readonly></td>
                                    <td><input type="text" class="form-control border-0 py-3" value="{{ $child_parent->self_score }}" placeholder="0">
                                    </td>
                                    <td><input type="text" class="form-control border-0 py-3" value="{{ $child_parent->class_score }}" placeholder="0">
                                    </td>
                                    <td><input type="text" class="form-control border-0 py-3" value="{{ $child_parent->note }}" placeholder="Sinh viên tự đánh giá" readonly></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control border-0 py-3" value="{{ $child->max_score }}" placeholder="0" readonly></td>
                                    <td><input type="text" class="form-control border-0 py-3" value="{{ $child->self_score }}" placeholder="0">
                                    </td>
                                    <td><input type="text" class="form-control border-0 py-3" value="{{ $child->class_score }}" placeholder="0">
                                    </td>
                                    <td><input type="text" class="form-control border-0 py-3" value="{{ $child->note }}" placeholder="Sinh viên tự đánh giá" readonly></td>
                                </tr>
                                @endif
                                @endforeach
                                @endif
