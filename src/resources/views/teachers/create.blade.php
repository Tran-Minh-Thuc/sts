                    ...
                    <div class="col-xl-6 col-md-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="create-teachers" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="donationinput1" class="form-control" placeholder="Mã giảng viên" name="teacher_code" >
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="tel" id="donationinput3" class="form-control" placeholder="Số điện thoại" name="phone_number">
                                            </div>
                                            <div class="form-group">
