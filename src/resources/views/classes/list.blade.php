    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-4 col-12 mb-2">
                <h3 class="content-header-title">Tất Cả lớp</h3>
            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="form-group">
                                    <a type="button" href="create-classes" class="btn mb-1 btn-primary btn-lg btn-block">Thêm một tài khoản mới</a>
                                </div>
