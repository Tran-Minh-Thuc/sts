        ...
        <div class="frame-parent10">
            <form action="update-classes/{{$class['id']}}" method="post">
                ...
                <div class="instance-parent">
                    ...
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">Tên lớp</div>
                            </div>
                            <div class="frame-parent17">
                                <input type="text" name="name" id="name" class="frame-parent18" value="{{$class['name']}}" required>
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">Tên bộ phận</div>
                            </div>
                            <div class="frame-parent17">
                                <input type="text" name="department_name" id="department_name" class="frame-parent18" value="{{$class['department_name']}}" required>
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">Giảng viên phụ trách</div>
                            </div>
                            <div class="frame-parent17">
                                <select class="thng-tin-lin" name="teacher_id" id="teacher_id">
                                    <option value="{{$class['teacher_id']}}" selected>{{$class['teacher_name']}} {{$class['teacher_code']}}</option>
                    ...
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">Tên khóa học</div>
                            </div>
                            <div class="frame-parent17">
                                <select class="thng-tin-lin" name="course_id" id="course_id">
                                    <option value="{{$class['course_id']}}" selected>{{$class['course_name']}}</option>
                    ...
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="text" class="frame-parent18" value="{{$class['created_at']}}" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="text" class="frame-parent18" value="{{$class['updated_at']}}" disabled>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="form-del-cri" class="button-muangay-wrapper" style="height:50px; top: 790px;display:none;">
                <div class="button-muangay" style="background-color: brown;">
                    <form action="/admin/delete-classes/{{$class['id']}}" method="post">
                        @csrf
                        @method('delete')
