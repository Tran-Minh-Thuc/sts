                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="form-group">
                                    <a type="button" href="create-permissions" class="btn mb-1 btn-primary btn-lg btn-block">Thêm một quyền mới</a>
                                </div>
    ...
    $(document).ready(function() {
        ...
        function del_data(id) {
            if(confirm('Are you sure you want to delete?')){
                $.ajax({
                    url:"/admin/delete-permissions/" + id,
                    method:"GET",
                    data:{query:id},
                    dataType:'json',
