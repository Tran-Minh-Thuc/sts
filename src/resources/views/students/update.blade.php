...
<body>
    <div class="trang-thm-mi-ngi-dng">
        <div class="foodter">
        ...
        <div class="trang-thm-mi-ngi-dng-inner">
            <div class="frame-container">
                ...
                <div class="instance-container">
                    <div class="frame-parent1">
                        <div class="danh-sch-ng-vin-wrapper">
                            <div class="danh-sch-ng1">Tất cả người dùng</div>
                        </div>
                ...
                <div class="instance-frame">
                    <div class="frame-parent2">
                        <div class="danh-sch-ng-vin-wrapper">
                            <div class="danh-sch-ng1">Thêm mới người dùng</div>
                        </div>
                        <img class="expand-more-icon1" alt="" src="./public/expand-more2.svg" />
                    </div>
                </div>
                <div class="instance-container">
                    <div class="frame-parent1">
                ...
                <div class="instance-container">
                    <div class="frame-parent1">
                        ...
                        <img class="expand-more-icon1" alt="" src="./public/expand-more5.svg" />
                    </div>
                </div>
                <div class="instance-container">
                    <div class="frame-parent1">
                        ...
                        <img class="expand-more-icon1" alt="" src="./public/expand-more6.svg" />
                    </div>
                </div>
                <div class="instance-wrapper">
                    <div class="frame-div">
                ...
                <div class="instance-wrapper">
                    <div class="frame-div">
                        ...
                        <img class="location-on-icon" alt="" src="./public/expand-more8.svg" />
                    </div>
                </div>
                <div class="instance-wrapper">
                    <div class="frame-div">
                        ...
                        <img class="location-on-icon" alt="" src="./public/expand-more9.svg" />
                    </div>
                </div>
            </div>
        </div>
        <div class="frame-parent10">
                ...
                <div class="instance-parent">
                    <div class="button-muangay-wrapper">
                        <div class="button-muangay">
                            <button type="submit" value="Xác nhận" style="width: 100%; height: 100%; color:black" class="lu-thay-i">
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">Tên</div>
                            </div>
                            <div class="frame-parent17">
                                <input type="text" name="full_name" id="full_name" class="frame-parent18" value="{{$student['full_name']}}">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <select class="thng-tin-lin" name="class_id" id="class_id">
                                    <option value="{{$student['class_id']}}" selected>{{$student['class_name']}}</option>
                    ...
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">Mã sinh viên</div>
                            </div>
                            <div class="frame-parent17">
                                <input type="number" name="student_code" class="frame-parent18" value="{{$student['student_code']}}">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">Giới tính</div>
                            </div>
                            <div class="frame-parent17">
                                <select name="sex" class="frame-parent18" value="{{$student['sex']}}">
                    ...
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">Ngày sinh</div>
                            </div>
                            <div class="frame-parent17">
                                <input type="date" name="date_of_birth" class="frame-parent18" value="{{$student['date_of_birth']}}">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">Nơi sinh</div>
                            </div>
                            <div class="frame-parent17">
                                <select  name="place_of_birth" class="frame-parent18" value="{{$student['place_of_birth']}}">
                                    <option value="{{$student['place_of_birth']}}" selected>{{$student['place_of_birth']}}</option>
                                    @foreach($provinces as $province)
                                    @if($province['name'] != $student['place_of_birth'])
                    ...
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">Số điện thoại</div>
                            </div>
                            <div class="frame-parent17">
                                <input type="number" name="phone_number" class="frame-parent18" value="{{$student['phone_number']}}">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">Số căn cước </div>
                            </div>
                            <div class="frame-parent17">
                                <input type="number" name="id_citizent" class="frame-parent18" value="{{$student['id_citizent']}}">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            <div class="nhp-m-s-wrapper">
                                <div class="nhp-m-s">Email</div>
                            </div>
                            <div class="frame-parent17">
                                <input type="text" name="email" class="frame-parent18" value="{{$student['email']}}">
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="text" class="frame-parent18" value="{{$student['created_at']}}" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="group-div">
                        <div class="frame-parent28">
                            ...
                            <div class="frame-parent17">
                                <input type="text" class="frame-parent18" value="{{$student['updated_at']}}" disabled>
                            </div>
                        </div>
                    </div>
                </div>
                <input id="update-image-btn" name="image" type="file" style="display: none;" onclick="previewImage()" class="avartarpng">
                <input id="update-image-qs" type="button" value="Thay đổi hình ảnh mới ?" class="avartarpng" onclick="viewButtonChangeImg()" style="display: block;">
                <img id="update-image-prv" class="frame-icon" alt="" src="data:image/png;base64,{{$student['image']}}" style="display: block;" />
                <div class="frame-icon" id="update-image-img" style="display: none;" data-img=""></div>
            </form>
            <button onclick="viewformdelete()" class="button-muangay-wrapper" style="margin-top:400px; height:50px; width:71px">
                xac nhan xoa
            </button>
            <div id="form-del-cri" class="button-muangay-wrapper" style="height:50px; top: 790px;display:none;">
                <div class="button-muangay" style="background-color: brown;">
                    <form action="/admin/delete-students/{{$student['image']}}" method="post">
                        @csrf
                        @method('delete')
